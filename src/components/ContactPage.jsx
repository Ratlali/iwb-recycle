      ...
      <div className="container mx-auto px-6 lg:px-8 max-w-7xl pb-16 md:pb-24 lg:pb-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center">
            ...
            <p className="text-gray-600 mb-4">+266 5773 6313</p>
          ...
          <div className="bg-blue-50 rounded-xl p-8 flex flex-col justify-center">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <span className="text-gray-700">Limkokwing University, Maseru, Lesotho</span>
              </div>
              ...
              <div className="flex items-start">
                ...
                <span className="text-gray-700">info@iwb.co.ls</span>
              </div>
              ...
              <div className="flex items-start">
                ...
                <span className="text-gray-700">+266 5773 6313</span>
              </div>
            </div>
