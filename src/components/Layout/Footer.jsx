            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    <div>
                        ...
                        <div className="space-y-3 text-gray-600">
                            <div className="flex items-start">
                                ...
                                <span>123 Tech Park, Johannesburg, South Africa</span>
                            </div>
                            <div className="flex items-start">
                                <svg className="w-5 h-5 mt-0.5 mr-3 text-teal-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <a href="mailto:info@techcycle.africa" className="hover:text-teal-600 transition-colors duration-200">info@techcycle.africa</a>
                            </div>
                            <div className="flex items-start">
                                <svg className="w-5 h-5 mt-0.5 mr-3 text-teal-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <a href="tel:+27111234567" className="hover:text-teal-600 transition-colors duration-200">+27 11 123 4567</a>
                            </div>
                            <div className="pt-2">
                                <a 
                ...
                <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <div className="text-gray-500 text-sm mb-4 md:mb-0">
                        © {new Date().getFullYear()} TechCycle Africa. All rights reserved.
                    </div>
